...
public boolean  equals(Object obj) {
	...
	if(obj instanceof IntArrayBag) {
		//cast the obj
		IntArrayBag newobj = (IntArrayBag)obj;
		
		if(newobj.manyItems != this.manyItems){
			return false;
		}//end of if statements 
		
		//find the max of the arrays
		max1 = newobj.data[0];
		for(int i : newobj.data) {
			if(i>max1) {
				max1 = i;
			}
		}
		...
		// if the max is not equal it is not equal and we 
		if(max1 != max2) {
			return false;
		}else {
			//make new arrays for comparing
			found1= new int[max1+1];
			found2= new int[max1+1];
		
			//counting the vales as the index
			//if the array has 2 10's the array will have a 2 at the index 10
			for(int i = 0; i < newobj.data.length;++i) {
				found1[newobj.data[i]]++;
			}
...
public static void main(String args[]) {
	//make a few objs
	IntArrayBag obj1 = new IntArrayBag();
	IntArrayBag obj2 = obj1.clone();
	
	//test if equal
	System.out.println("comparing 1 and 2 should be true >>> "+obj1.equals(obj2)+"\nadding 4 too obj1 and 8 too obj2...");
	obj1.add(4);
	obj2.add(8);
	System.out.println("comparing 1 and 2 should be false >>> "+obj1.equals(obj2)+"\nadding 8 too obj1...");
	obj1.add(8);
	System.out.println("comparing 1 and 2 should be false >>> "+obj1.equals(obj2)+"\nadding 4 too obj2...");
	obj2.add(4);
	System.out.println("comparing 1 and 2 should be true >>> "+obj1.equals(obj2));
